...
//   6 surface + elevated ribbons, landmarks, ferries, over-water train
//   reflections (0.004) · 7 stations (surface/elevated orbs + watercolor
//   seals) · 8 trails · 9 train model (depthWrite:true) · 10 glow sprites +
//   headlights · 11 labels (depthTest off) · 12 rain streaks (clip-space,
//   depthTest off)
...
const FRAG = /* glsl */ `
  ...
  void main() {
    ...
    // Wet paper: real rain (world/weather.ts) darkens the sheet and lets
    // the washes bleed deeper, the way pigment spreads on damp cotton.
    vec3 c = uGround + uPaperTint * (wash - 0.5) * (1.0 + 0.6 * uRain);
