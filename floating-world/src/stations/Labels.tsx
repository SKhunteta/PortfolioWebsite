...
function labelTexture(name: string) {
  ...
  const accent = identityForName(name)?.accent ?? "#c7452e";
  ...
  // Soft washi backing so the name reads as ink on a paper slip — warm in
  // both looks (a lantern-lit label after dark, a bright one by day).
  const grad = ctx.createLinearGradient(0, 0, w, 0);
  grad.addColorStop(0, "rgba(240,228,200,0)");
  grad.addColorStop(0.18, "rgba(240,228,200,0.82)");
  grad.addColorStop(0.82, "rgba(240,228,200,0.82)");
