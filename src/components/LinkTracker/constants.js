...
export const STATIONS = [
  ...
  },
  {
    ...
    lng: -122.4392,
    neighborhood: "Downtown Tacoma",
    blurb: "A central T Line station in downtown Tacoma's Theater District at South 11th Street. Near the Tacoma Art Museum, Museum of Glass, and the historic Pantages Theater.",
    operational: true,
    openedYear: 2011,
    notableFact: "Originally named Commerce Street, this infill station was added in 2011 and renamed Theater District to reflect its cultural surroundings.",
  },
  {
    id: "old-city-hall",
    name: "Old City Hall",
    ...
    lng: -122.4404,
    neighborhood: "Downtown Tacoma",
    blurb: "Station near Tacoma's historic Old City Hall, a Romanesque Revival landmark built in 1893. Part of the 2023 Hilltop Link Extension.",
    operational: true,
    openedYear: 2023,
    notableFact: null,
  },
  {
    ...
    lng: -122.4428,
    neighborhood: "Downtown Tacoma",
    blurb: "Station along South 4th Street in downtown Tacoma, part of the Hilltop Link Extension providing access to the Stadium District area.",
    operational: true,
    openedYear: 2023,
    notableFact: null,
  },
  ...
  },
  {
    ...
    blurb: "Station near Tacoma General Hospital (now St. Joseph Medical Center-Tacoma). Part of the Hilltop Link Extension serving the medical district.",
    operational: true,
    openedYear: 2023,
    notableFact: null,
  },
  {
    ...
    lng: -122.4529,
    neighborhood: "Hilltop",
    blurb: "Station along 6th Avenue in the Hilltop neighborhood, a vibrant commercial corridor with independent shops, restaurants, and galleries.",
    operational: true,
    openedYear: 2023,
    notableFact: null,
  },
  {
    ...
    lng: -122.4517,
    neighborhood: "Hilltop",
    blurb: "A key T Line station in Tacoma's Hilltop neighborhood. The Hilltop Link Extension brought transit access to this historically underserved community.",
    operational: true,
    openedYear: 2023,
  ...
  },
  {
    ...
    lng: -122.4502,
    neighborhood: "Hilltop",
    blurb: "The current western terminus of the T Line near St. Joseph Medical Center. Future plans extend the line further west along S 19th Street to Tacoma Community College.",
    operational: true,
    openedYear: 2023,
    notableFact: "The T Line was the first modern light rail line in the Puget Sound region, opening its initial segment in 2003.",
  },

  // ===== T Line - Planned TCC Extension =====
  {
    id: "s-19th",
    name: "S 19th Street",
    lines: ["t-line"],
    ...
    blurb: "Planned station on the T Line TCC extension along South 19th Street, the primary corridor for the 3.5-mile extension to Tacoma Community College.",
    operational: false,
    openedYear: null,
    notableFact: null,
  },
  {
    ...
    lng: -122.4640,
    neighborhood: "West Tacoma",
    blurb: "Planned station on the T Line TCC extension, serving the Stevens Street area along the S 19th Street corridor.",
    operational: false,
    openedYear: null,
    notableFact: null,
  },
  ...
  },
  {
    ...
    lng: -122.4800,
    neighborhood: "West Tacoma",
    blurb: "Planned station along the S 19th Street corridor on the T Line extension to Tacoma Community College.",
    operational: false,
    openedYear: null,
    notableFact: null,
  },
  {
    ...
    lng: -122.4880,
    neighborhood: "West Tacoma",
    blurb: "Planned station near Pearl Street, one of the final stops before Tacoma Community College on the T Line extension.",
    operational: false,
    openedYear: null,
    notableFact: null,
  },
  {
    ...
    lng: -122.4970,
    neighborhood: "West Tacoma",
    blurb: "The planned western terminus of the T Line at Tacoma Community College (TCC). The 3.5-mile extension along S 19th Street will carry approximately 18,000 daily riders.",
    operational: false,
    openedYear: null,
    notableFact: "When complete, the T Line will span 8.4 miles with 18 stations from Tacoma Dome to Tacoma Community College.",
  },
];
...
export const LINE_PATHS = {
  ...
  "t-line": [
    ...
    [47.2398, -122.4281],  // Tacoma Dome
    [47.2391, -122.4342],  // S 25th
    [47.2430, -122.4360],  // Union Station
    [47.2496, -122.4385],  // Convention Center
    [47.2523, -122.4392],  // Theater District
    [47.2577, -122.4404],  // Old City Hall
    [47.2613, -122.4428],  // S 4th
    [47.2639, -122.4490],  // Stadium District
    [47.2600, -122.4535],  // Tacoma General
    [47.2569, -122.4529],  // 6th Ave
    [47.2518, -122.4517],  // Hilltop District
    [47.2451, -122.4502],  // St Joseph
    // Planned TCC Extension along S 19th Street
    [47.2440, -122.4570],  // S 19th Street
    [47.2435, -122.4640],  // Stevens
    [47.2430, -122.4720],  // Union Avenue
    [47.2425, -122.4800],  // Sprague
    [47.2420, -122.4880],  // Pearl
    [47.2415, -122.4970],  // Tacoma Community College
  ],
};
