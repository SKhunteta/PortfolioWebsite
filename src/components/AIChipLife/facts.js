...
export const FACTS = {
  ...
  euv_units_2025: {
    ...
    value: "48 units",
    numeric: 48,
    source: "ASML EUV system shipments, full year 2025.",
    verified: true,
    confidence: "verified",
    verifiedDate: "2026-05-01",
    reverifyDays: 180,
  ...
  tsmc_leading_edge: {
    ...
    label: "TSMC share of leading-edge chips",
    value: "~90%",
    numeric: 90,
    source: "TSMC's share of the most advanced (leading-edge) chips.",
    verified: false,
    confidence: "needs_verification",
    verifiedDate: null,
    reverifyDays: 90,
    note: "Phrase as leading-edge share only, never '90% of all chips'.",
  },
  ...
  cowos_bottleneck: {
    ...
    numeric: null,
    source: "CoWoS packaging capacity, not transistors, bound 2023–24 supply.",
    verified: false,
    confidence: "needs_verification",
    verifiedDate: null,
    reverifyDays: 90,
    note: "Stub. SHREY to source CoWoS capacity figures before launch.",
  },
  rack_power: {
    id: "rack_power",
