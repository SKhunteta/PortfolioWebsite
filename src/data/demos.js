...
export const DEMOS = [
  ...
  },
  {
    ...
    kindLabel: "Survival game",
    tagline: "Twelve months of luxury living. Allegedly.",
    description:
      "Survive eleven months of elevator outages, AI leasing assistants, and Parcel Pending notifications — then negotiate your renewal against the Centralized Services desk. Your only weapon is documentation.",
    cta: "Sign the lease",
    tags: ["game", "satire"],
    live: false,
    series: null,
    featured: false,
    sourceDir: "src/components/ApartmentSurvivalSim",
    theme: {
      bg: "#EDEFF1",
      text: "#14202B",
      muted: "#5A6B7A",
