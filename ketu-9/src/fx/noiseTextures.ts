...
// Procedural detail textures (no external assets — everything on Ketu-9 is
// code-generated). A tileable FBM heightfield becomes a tangent-space normal
// map (surface chisel for the glassbears' ice, wet-hide breakup for the
// leviathans) and a matching roughness map.
